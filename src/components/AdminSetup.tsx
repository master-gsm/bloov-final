    ...
    return (
      <div className="min-h-screen flex items-center justify-center login-background px-4">
        <div className="max-w-md w-full text-center">
          <div className="bg-white/85 backdrop-blur-md p-8 rounded-2xl shadow-2xl border border-violet-200/40">
            <div className="w-16 h-16 bg-violet-100 rounded-full flex items-center justify-center mx-auto mb-4">
              <Shield className="w-8 h-8 text-violet-600" />
            </div>
            <h2 className="text-2xl font-bold text-violet-900 mb-2">Admin Created!</h2>
    ...
    <div className="min-h-screen flex items-center justify-center login-background px-4">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold text-violet-900 drop-shadow-sm">Create Admin Account</h2>
          <p className="mt-2 text-sm text-violet-700/80">Set up the first administrator for your BLOOV system</p>
        </div>
        ...
        <form className="mt-8 space-y-6 bg-white/85 backdrop-blur-md p-8 rounded-2xl shadow-2xl border border-violet-200/40" onSubmit={handleSubmit}>
          ...
          <div className="space-y-4">
            <div>
              <label htmlFor="fullName" className="block text-sm font-medium text-violet-900 mb-1">
                Full Name
              </label>
              <input
                id="fullName"
            ...
            <div>
              ...
              <input
                ...
                dir="ltr"
              />
              <p className="mt-1 text-xs text-violet-600/60">Letters, numbers, dots, hyphens only</p>
            </div>
            ...
            <div>
              ...
              <input
                ...
                minLength={6}
              />
              <p className="mt-1 text-xs text-violet-600/60">Minimum 6 characters</p>
            </div>
          </div>
