  ...
  return (
    <div className="relative flex-shrink-0">
      ...
      >
        ...
        {badgeCount > 0 && (
          <span className={`absolute -top-1 -right-1 min-w-[18px] h-[18px] ${badgeColor} text-white text-[10px] font-bold rounded-full flex items-center justify-center px-1 animate-pulse`}>
