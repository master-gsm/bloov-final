...
/*
  # Fix VAT account code in create_sale_atomic

  ## Change
  Replace account code '2200' with '2130' (VAT Payable) when looking up
  the VAT output account inside create_sale_atomic.
