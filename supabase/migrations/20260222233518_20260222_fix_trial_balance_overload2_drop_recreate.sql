/*
  # Fix get_trial_balance second overload
  
  Drop and recreate the second overload (p_branch_id, p_date_from, p_date_to).
  Fixes:
    - je.entry_date → je.date (correct column in journal_entries)
    - a.account_type → a.type (correct column in accounts table)
*/
