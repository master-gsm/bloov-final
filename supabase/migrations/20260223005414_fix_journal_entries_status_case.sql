...
/*
  # Fix journal_entries status case in create_sale_atomic

  ## Problem
  The function create_sale_atomic inserts 'posted' (lowercase) into journal_entries.status,
  but the valid_status CHECK constraint only accepts 'Posted' (capitalized).

  ## Change
  Replace 'posted' with 'Posted' in the INSERT INTO journal_entries statement inside
  create_sale_atomic. No other logic is changed.
*/
