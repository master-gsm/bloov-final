...
/*
  # Fix create_sale_atomic: Insert journal_entry as 'Draft', then update to 'Posted'

  ## Problem
  The journal_entry was being inserted with status = 'Posted' directly, which
  caused the trigger/check "Cannot modify lines of Posted journal entry" to fire
  when trying to insert journal_lines immediately after.
  ...
  ## No changes to any accounting logic, amounts, or other operations.
*/
...
-- Step 2: Insert all journal lines
